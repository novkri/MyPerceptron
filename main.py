...
# 200 обуч и 100 тестовых. каждое 3 в тест выбор
...
class neural_network(object):
    def __init__(self):
        ...
        self.W2 = np.random.randn(self.hiddenSize, self.hiddenSize2) / 1
        self.W3 = np.random.randn(self.hiddenSize2, self.outputSize) / 1
    ...
    def backward(self, X, y, o):
        ...
        self.W1 += 0.01 * np.dot(X.T, self.z2_delta)
        self.W2 += 0.01 * np.dot(self.z2.T, self.z4_delta)
        self.W3 += 0.01 * np.dot(self.z4.T, self.o_delta)
...
for i in range(30000):
    ...
    # # print ("Input: \n" + str(X))
    # # print("Actual Output: \n" + str(y * 1000))
    # # print("Predicted Output: \n" + str(NN.forward(X) * 1000))
    # # print("Loss: \n" + str(np.mean(np.square(y - NN.forward(X))) * 1000))
    # print("\n")
    NN.train(X, y)
    # сортировка:
